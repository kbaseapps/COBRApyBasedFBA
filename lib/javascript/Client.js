...
function COBRApyBasedFBA(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_fba_pipeline = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "COBRApyBasedFBA.run_fba_pipeline",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "COBRApyBasedFBA.status",
